...
- Once a robot is placed, place function is disabled and cannot be used again. Unless user resets the game using the button on the right side of the terminal.
- use left(), right(), move() and back() for navigation
